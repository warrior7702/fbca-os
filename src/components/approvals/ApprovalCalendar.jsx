...
export default function ApprovalCalendar({ approvals, onOpenFullView }) {
  ...
  // Group approvals by date (using event start time if available)
  const approvalsByDate = {};
  approvals.forEach((approval) => {
    // Try to get date from approval attributes
