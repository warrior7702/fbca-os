...
const defaultApps = [
  ...
  { id: "eventhub", name: "Event Hub", icon: Ticket, color: "from-rose-500 to-pink-500", path: "EventHub" },
...
const getDefaultPositions = () => {
  return {
    ...
    eventhub: { row: 1, col: 1 },
    campushub: { row: 1, col: 2 },
    communications: { row: 1, col: 3 },
    foodservice: { row: 1, col: 4 },
    support: { row: 2, col: 0 },
    staffdir: { row: 2, col: 1 },
    documents: { row: 2, col: 2 },
    inboxhelper: { row: 2, col: 3 },
    planningtool: { row: 2, col: 4 },
    sharepoint: { row: 3, col: 0 },
